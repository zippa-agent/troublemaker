...
pulse.record("C0AN1GL51K7", "U0A06NNJV34", rawMarkdown.length, rawMarkdown, "1779776969.882709");
pulse.record("C0AN1GL51K7", "U0A06NNJV34", slackMrkdwn.length, slackMrkdwn, "1779776969.882709");
...
pulse.record("C0AN1GL51K7", "U0A06NNJV34", "another reply".length, "another reply", "1779777014.658729");
