...
assert.match(voiceHook, /compact context handoff plus the live workspace tool list/, "web voice hook documents live Realtime tool exposure");
...
assert.match(voiceHook, /fetchWorkspaceToolDefinitions/, "Realtime fetches the live workspace tool list");
assert.match(voiceHook, /\n\s*tools,/, "Realtime session update uses fetched tool definitions");
