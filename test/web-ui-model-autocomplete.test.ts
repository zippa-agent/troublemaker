...
assert(getModelSuggestions(models, '', 'fireworks/accounts/fireworks/models/glm-5p1')[0]?.value === 'fireworks/accounts/fireworks/models/glm-5p1', 'current model sorts first for empty query');
