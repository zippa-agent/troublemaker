...
1. **Incomplete work:** Did anything crash or fail to deliver? If so, pick it up and finish it. Use \`send_message\` to deliver on the right channel (email, Telegram, Slack).
2. **Proactive outreach:** Is there anything worth reaching out to your owner about? A follow-up, a reminder, something you noticed? Use \`send_message\` to send it on the appropriate channel.
