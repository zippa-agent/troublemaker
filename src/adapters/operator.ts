...
Replies to the operator happen through whatever channel you were already using with your principal (Telegram, Slack, email, etc.) via \`send_message\`. The operator channel itself has no outbound path.`;
